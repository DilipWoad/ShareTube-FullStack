  ...
  return (
    <div className="bg-gray-500 h-28 border-y-[1px] items-center flex rounded-lg">
      <div className="bg-gray-400 h-24 w-full flex items-center px-2">
        ...
        <div className="flex bg-lime-300 w-[750px]">
          <div className="mr-4">
            <img
        ...
        <div className="mx-3 flex items-center justify-center w-24">
            {views} views
        </div>
        
        <div className ="flex items-center justify-center bg-purple-400 h-full w-20">
